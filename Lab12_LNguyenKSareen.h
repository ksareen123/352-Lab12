/*****************************************************************************
*                                                                            *
*       Source title:   Lab12_LNguyenKSareen.H
...
// See Lab12_LNguyenKSareen.cpp for the implementation of this class
//
...
#define      PIN_DEFINITION( pinname, pingrpval, site0 ) \
	...
	PIN_DEFINITION (PWR, 8194 , 33)	// defines  PWR_S0
...
class CLab12_LNguyenKSareen : public CTestMain
{
public:
    CLab12_LNguyenKSareen(PRG_FLOW *UserFlow) : CTestMain(UserFlow) {};
    ~CLab12_LNguyenKSareen(){};
...
//  Function body in the Lab12_LNguyenKSareen.cpp file
//
